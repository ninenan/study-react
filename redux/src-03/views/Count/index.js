...
export default () => {
  ...
  const incrementAsync = () => {
    dispatch(createIncrementActionAsync(+selectRef.current.value, 1_500))
  }
  ...
  return (
    <>
      ...
      <button className="button asyncButton" onClick={() => incrementAsync()} disabled={isIncrementAsyncBtnDisabled}>异步增加</button>
    </>
  )
}
